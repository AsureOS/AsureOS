:: AsureOS is a custom windows 10 based on 20H2
:: POST INSTALLATION SCRIPT

@echo off
TITLE AsureOS POST-INSTALL v0.6.4
...
:: INSTALL DIRECTX
call %SYSTEMROOT%\Modules\DirectX\dxsetup.exe /silent

:: INSTALL VCREDIST
call %SYSTEMROOT%\Modules\vcredist.exe /aiV /gm2

:: INSTALL AND SETUP OPEN-SHELL
call %SYSTEMROOT%\Modules\openshell.exe /qn ADDLOCAL=StartMenu
...
:: INSTALL 7-ZIP
call %SYSTEMROOT%\Modules\7zip.msi /quiet /norestart
...
:: DUAL BOOT OPTIONS
bcdedit /set {current} description "AsureOS" >nul 2>&1
